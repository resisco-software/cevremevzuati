    ...
    <div>
      <label className="relative block max-w-2xl" htmlFor="glossary-search">
        ...
        <Input
          ...
          className="h-12 rounded-[10px] bg-card pl-11 shadow-none"
      ...
      <div className="mt-5 flex items-center justify-between border-b border-border pb-4 text-sm text-muted-foreground">
        ...
        <span className="hidden sm:inline">
          Her tanımda madde kaynağı gösterilir
        </span>
      </div>
        ...
        <div className="divide-y divide-border">
          {filtered.map((entry) => (
            <article
              ...
              className="grid gap-5 py-7 lg:grid-cols-[200px_1fr_230px] lg:gap-8"
            >
              <div>
              ...
              <div className="rounded-[12px] border border-border/70 bg-secondary/55 p-4 text-xs leading-5">
